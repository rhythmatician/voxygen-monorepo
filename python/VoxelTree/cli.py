...
def _launch_gui() -> None:
    from VoxelTree.gui.app import create_app  # noqa: PLC0415
    from VoxelTree.gui.main_window import MainWindow  # noqa: PLC0415
...
def _cmd_list_steps() -> None:
    ...
    from VoxelTree.gui.step_definitions import PIPELINE_STEPS  # noqa: PLC0415
...
def _cmd_server(action: str, role: str | None) -> None:
    ...
    from VoxelTree.gui.server_manager import (  # noqa: PLC0415
        _JAR_PATH,
        _RUNTIME_DIR,
