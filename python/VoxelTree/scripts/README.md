...
|--------|-------|-------------|
| `stage1/` | Stage-1 Density | Train, extract, distill the tiny density NN + terrain shaper |
| `sparse_root/` | Sparse Root | Train, distill, calibrate the sparse-root occupancy model |
