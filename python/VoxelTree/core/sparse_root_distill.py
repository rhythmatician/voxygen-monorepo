...
def _evaluate_student(
    ...
    *,
    ...
    loader = DataLoader(
        ...
        shuffle=False,
        collate_fn=sparse_root_collate,
    )
    split_correct = 0.0
    split_total = 0.0
    leaf_correct = 0.0
...
def distill_sparse_root(
    *,
    ...
    dataset = SparseRootDataset(data_path, cache_targets=True)
    loader = DataLoader(
        dataset,
        batch_size=batch_size,
        shuffle=True,
...
__all__ = ["checkpoint_metadata", "distill_sparse_root"]
