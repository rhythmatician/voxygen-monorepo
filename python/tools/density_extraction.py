...
class DensityFieldExtractor:
    ...
    def extract_density_values(self, 
                               chunk_x: int, 
                               chunk_z: int,
                               y_range: Tuple[int, int] = (-64, 320)) -> np.ndarray:
        """
...
def main():
    ...
    extract.add_argument('--output', type=Path, default='training_data/',
                         help='Output directory')
    extract.add_argument('--server', default='http://localhost:25575',
                         help='Minecraft Rcon URL')
    ...
    if args.command == 'extract':
        ...
        logger.warning("Extraction pipeline not yet implemented. "
