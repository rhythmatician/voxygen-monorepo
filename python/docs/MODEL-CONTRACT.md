...
### C.5 Model: `lodiffusion.v7.voxy`

**Contract ID:** `lodiffusion.v7.voxy`
**Version:** `7.0.0`
**Python source:** `voxel_tree/tasks/sparse_octree/sparse_octree.py`, `voxel_tree/tasks/sparse_octree/export_voxy.py`
...
```json
{
  "contract": "lodiffusion.v7.voxy",
  "version": "lodiffusion.v7.voxy",
  "blockVocabSize": 1040,
  "spatialY": 4,
...
All v7 models train from a shared NPZ file (`voxy_pairs_v7.npz`):
...
python -m voxel_tree.tasks.voxy.build_sparse_octree_pairs --dumps v7_dumps

# 3. Train all 4 models
python -m voxel_tree.tasks.density_v2.train_density_v2 --data voxy_pairs_v7.npz
python -m voxel_tree.tasks.biome.train_biome_classifier --data voxy_pairs_v7.npz
python -m voxel_tree.tasks.heightmap.train_heightmap --data voxy_pairs_v7.npz
# sparse_octree trains from the same NPZ via train_voxy()
...
python LODiffusion/models/export_voxy.py --checkpoint ... --out-dir production
