...
MODEL_CONTRACT = "lodiffusion.v7.density_v2"
MODEL_VERSION = "7.0.0"
...
def export(checkpoint_path: Path, out_dir: Path) -> None:
    ...
    sidecar = {
        ...
        "description": "DensityV2: 6 climate RouterFields → 2 density outputs (per quart cell)",
        ...
        "output": {
            ...
            "note": "preliminary_surface_level + final_density per quart cell",
        },
        "training": {
            "epoch": epoch,
