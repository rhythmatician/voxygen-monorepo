...
try:
    from voxel_tree.tasks.sparse_octree.sparse_octree_distill import distill_sparse_octree
...
def main(argv=None):
    ...
    parser.add_argument("--data", type=Path, required=True, help="Path to sparse_octree_pairs.npz")
    parser.add_argument(
        "--teacher-checkpoint",
        type=Path,
        required=True,
    ...
    parser.add_argument(
        "--out",
        type=Path,
        default=Path("distilled_sparse_octree.pt"),
