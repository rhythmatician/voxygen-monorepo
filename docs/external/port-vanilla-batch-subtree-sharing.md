...
* **`SectionNoiseData.FLAT_LENGTH` is 480 (Overworld-only)** — `VanillaNoiseRouterSampler.java:57-76` and `QuartNoiseCompute.java:68` use `4×2×4=32` points ×15 = 480 floats per 16³ section (2 Y quarts per section because `cellHeight=8` → `16/8=2` cells, Overworld lattice). Neither is `8×8` or `16×16`.
