...
public interface VoxelVolumeWriter {
     ...
     */
    public default WriteOutcome writeRegion(
     ...
     */
    public default ParentRefinementResult refineParent(ParentRefinementIntent intent) {
     ...
     */
    public default int saveQueueDepth() {
        return 0;
    }
    ...
    public default boolean isRegionFullyPopulated(SectionPos origin, Level level) {
        return false;
    }
     ...
     */
    public default boolean hasRegionCoverage(SectionPos origin, Level level) {
        return false;
    }
