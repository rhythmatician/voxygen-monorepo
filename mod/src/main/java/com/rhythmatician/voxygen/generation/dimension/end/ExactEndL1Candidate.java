...
public final class ExactEndL1Candidate {
    ...
    public ExactEndL1Candidate(WorldNoiseAccess noiseAccess) {
        this(noiseAccess, new ExactL1SamplingTelemetry());
    }

    public ExactEndL1Candidate(WorldNoiseAccess noiseAccess, ExactL1SamplingTelemetry telemetry) {
    ...
    public ExactEndL1Candidate(ChunkColumnSampler sampler) {
        this(sampler, new ExactL1SamplingTelemetry());
    }

    public ExactEndL1Candidate(
            ChunkColumnSampler sampler, ExactL1SamplingTelemetry telemetry) {
        this.sampler = Objects.requireNonNull(sampler, "sampler");
        this.telemetry = Objects.requireNonNull(telemetry, "telemetry");
    }

    public VoxelVolume produceExactL1(SectionPos origin) {
