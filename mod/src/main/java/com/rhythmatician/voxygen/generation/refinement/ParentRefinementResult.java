...
public record ParentRefinementResult(
    ...
    public static ParentRefinementResult published(WriteOutcome outcome) {
    ...
    public static ParentRefinementResult published(
    ...
    public static ParentRefinementResult parentMissing() {
