...
public final class VanillaFrontierGuardPlanner {
    public static final int L1_PARENT_WIDTH_BLOCKS = WorldSectionCoord.worldSectionWidth(Level.L1.value());
    public static final int L1_PARENT_WIDTH_SECTIONS =
            L1_PARENT_WIDTH_BLOCKS / WorldSectionCoord.BLOCKS_PER_SECTION;
    public static final int MINIMUM_LEAD_BLOCKS = L1_PARENT_WIDTH_BLOCKS;
