 ...
 */
public final class EndL4DeterministicCandidate {

    public static final int BLOCK_AIR = CanonicalRegistries.BLOCK_AIR;
    public static final int BLOCK_END_STONE = 359; // canonical minecraft:end_stone
    public static final int EXTENT = 32;
    public static final int END_MIN_Y = 0;
    public static final int END_MAX_Y = 128;

    private final WorldNoiseAccess noiseAccess;

    public EndL4DeterministicCandidate(WorldNoiseAccess noiseAccess) {
        if (noiseAccess == null) {
     ...
     */
    public VoxelVolume produceL4Region(SectionPos origin) {
