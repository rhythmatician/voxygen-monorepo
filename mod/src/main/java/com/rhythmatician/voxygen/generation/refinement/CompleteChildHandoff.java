 ...
 */
public record CompleteChildHandoff(byte presentMask, byte emptyMask) {
    private static final int ALL_OCTANTS = 0xFF;

    public CompleteChildHandoff {
    ...
    public static CompleteChildHandoff ofMasks(int presentMask, int emptyMask) {
