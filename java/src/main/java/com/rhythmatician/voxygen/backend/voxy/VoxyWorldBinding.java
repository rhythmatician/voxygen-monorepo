...
public final class VoxyWorldBinding {
    ...
    public static final int CHILD_EXISTENCE_UPDATE_FLAG = 2;
    ...
    public static Field worldSectionDataField;

    /** {@code WorldSection.nonEmptyChildren} — octant-presence bitmask for GPU octree traversal. */
    public static Field worldSectionNonEmptyChildrenField;
     ...
     */
    public static void ensureWorldSectionBindings() {
     ...
     */
    public static int clampToNativeRes(int coord, int scale, int nativeRes) {
    ...
    public static void publishCompleteChildMask(Object worldEngine, int parentLvl,
    ...
    @FunctionalInterface
    public interface SectionDirtyNotifier {
        void mark(Object worldSection, int updateFlags) throws Exception;
    }

    public static void writeAcquiredWorldSection(Object worldSection,
                                          int lvl,
                                          long[] voxels,
                                          byte preserveOctantsMask,
    ...
    public static boolean claimGeneratedFallbackForTest(Object worldSection, int lvl) {
        ensureWorldSectionBindings();
        try {
    ...
    public static boolean publishCompleteChildMaskForTest(Object parentSection, byte finalMask) {
        ensureWorldSectionBindings();
     ...
     */
    public static boolean publishCompleteChildMaskForTest(
    ...
    public static byte fallbackPresentationNec(boolean ownedFallback, byte currentNec) {
        return ownedFallback ? 0 : currentNec;
    }

    public static byte completeHandoffMask(byte generatedChildren, byte storedChildren) {
     ...
     */
    public static byte advertisedChildMask(byte storedChildren) {
        return storedChildren;
    }

    public static int generatedFallbackUpdateFlags(boolean topologyChanged) {
        return BLOCK_UPDATE_FLAG | (topologyChanged ? CHILD_EXISTENCE_UPDATE_FLAG : 0);
    }

    public static int completeHandoffUpdateFlags(boolean parentGeometryChanged) {
     ...
     */
    public static boolean mergeNonEmptyChildren(Object worldSection, byte childMask) {
    ...
    public static byte mergeChildMasks(byte existingMask, byte committedMask) {
     ...
     */
    public static long[] readAndUpsampleParentOctant(Object worldEngine, int parentLevel, int pX, int pY, int pZ, int octant) {
    ...
    public static byte computeOccupiedOctantMaskForTest(long[] data) {
     ...
     */
    public static boolean shouldSkipWriteForVerifiedChildren(byte advertisedChildMask,
     ...
     */
    public static int writeAcquiredWorldSectionReturningNonAir(
